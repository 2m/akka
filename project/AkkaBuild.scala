...
object AkkaBuild extends Build {
  ...
  override def buildLoaders = BuildLoader.transform(Sample.buildTransforer) :: Nil
  ...
  lazy val samples = Project(
    ...
    aggregate = Seq(sampleCamelJava, sampleCamelScala, sampleClusterJava, sampleClusterScala, sampleFsmScala,
      /*sampleHelloKernel,*/ sampleMainJava, sampleMainScala, sampleMultiNodeScala, samplePersistenceJava,
      samplePersistenceScala, sampleRemoteJava, sampleRemoteScala
      /*,
          remoteSampleJava, remoteSampleScala, clusterSampleJava, clusterSampleScala,
          , persistenceSampleJava, persistenceSampleScala,
